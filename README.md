...
[![GoDoc](https://godoc.org/gitlab.com/nielsen-media/eng/reference/commons/goav?status.svg)](https://godoc.org/gitlab.com/nielsen-media/eng/reference/commons/goav)

## Usage

`````go

import "gitlab.com/nielsen-media/eng/reference/commons/goav/avformat"
...
``` 
go get gitlab.com/nielsen-media/eng/reference/commons/goav
